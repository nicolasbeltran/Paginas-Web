...
<main>
	...
	<section id="integrantes">
           <div class="fotos">
              <figure class="agus"><img src="imagenesfinal/agusweb.jpg"  width="25%" alt=""><figcaption><p class="nombre" >Agustín Giovenale</p><p class="descripcion">Estudiante de Ciencias de la Comunicación en la Universidad de Buenos Aires, con aspiraciones en seguir publicidad. Baterista. Cinéfilo. Sociable y simpático.</p> </figcaption></figure>
              <figure class="joel"><img src="imagenesfinal/joelweb.jpg" width="25%" alt=""><figcaption><p class="nombre">Joel Pica</p><p class="descripcion">Estudiante de Ciencias de la Comunicación. Sobrevivo en el Ministerio de Cultura de la Nacion. Amo las palabras y creo firmemente que un algoritmo es un algoritmo.</p></figcaption></figure>
              <figure class="nuria"><img src="imagenesfinal/nuria.png"  width="25%" alt=""><figcaption><p class="nombre">Nuria Banus</p><p class="descripcion">Estudiante de Ciencias de la Comunicación. Las fotos carnet le parecen un vejámen a la fotografía.</p> </figcaption></figure>
           </div>
    ...
    <section id="mapasitio">
    	...
    	<form action="" method="post">
			...
			<?php
				...
				$to = 'joel_beltran_92@hotmail.com'; 
...
<footer id="footer2">
	<p>Página diseñada y desarrollada por <a href="http://www.joellasbeltran.com.ar" target="_blank" id="desarrollador">Nicolás Beltrán</a></p>
</footer>
